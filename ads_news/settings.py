"""
Django settings for ads_news project.
...
WSGI_APPLICATION = 'ads_news.wsgi.application'
...
LOCALE_PATHS = [
    BASE_DIR / 'locale',  # Diretório onde os arquivos de tradução ficarão
]
